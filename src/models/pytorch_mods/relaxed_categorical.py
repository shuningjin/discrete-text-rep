...
ExpRelaxedCategorical.log_prob
    last line: return score + log_scale -> return score + log_scale.squeeze()
To accomodate temperature tensor with shape (M, 1), otherwise can only use shape (1)

Based on: https://pytorch.org/docs/1.3.0/_modules/torch/distributions/relaxed_categorical.html#RelaxedOneHotCategorical
'''
...
class ExpRelaxedCategorical(Distribution):
    ...
    def log_prob(self, value):
        ...
        return score + log_scale.squeeze()
